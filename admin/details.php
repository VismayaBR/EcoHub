...
$detail=mysqli_query($conn,"SELECT * FROM register_tb JOIN login_tb ON register_tb.login_id=login_tb.login_id WHERE reg_id='$details'");
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>                                       
                                            ...
                                            <td><a class="btn btn-danger btn-sm"   href="view_req_equipment.php">Back</a></td>
                                        </tr>
